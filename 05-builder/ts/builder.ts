...
const gabriel = personBuilder
  .setName("Gabriel")
  .setLastName("Bordenabe")
  .addHobby("Comer")
  .addHobby("dormir")
  .build();
...
const sacha = personBuilder
  .setName("Sacha")
  .setLastName("Gianelli")
  .setCity("Cordoba")
...
const directorTS = new PersonDirector(personBuilder);
directorTS.createSimplePerson("Mauricio", "Mazuecos");
const green = personBuilder.build();
console.log(green);
